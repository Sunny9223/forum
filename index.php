...
<html lang="en">
  ...
  <body>
    ...
    <div class="carousel-inner">
        ...
        <img src="https://source.unsplash.com/2400x700/?programmer" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
        <img src="https://source.unsplash.com/2400x700/?ios" class="d-block w-100" alt="...">
        </div>
    </div>
    ...
    <!--Cerousel here-->
    <h2 class="text-center my-2">Forum - Categories</h2>
    <div class="container">
        <div class="row">
    <?php
